...
✏️ **Your turn:** Why do we check the shady side on its own rather than `p_df$needle_length_mm` (both sides pooled)? What would pooling two groups with different means do to the shape of the distribution? `________________________`
