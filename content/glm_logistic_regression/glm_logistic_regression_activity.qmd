...
>
> **Every grey `r` box below is code you type into an R script — not into the Console.** Before you start: **File → New File → R Script**, and save it as `08_glm_logistic_regression.R` in your project's `scripts/` folder. Then work down the worksheet, adding each block to the bottom of that one script, in order.
>
...
✏️ **Your turn:** Looking at the boxplot, does species richness look roughly normally distributed within each size category, or right-skewed?
...
``` r
# ── Part 2.1 · Gaussian GLM = Linear Model ──────────────────────────────
...
``` r
# ── Part 2.2 · Gaussian GLM = Linear Model ──────────────────────────────
...
``` r
# ── Part 2.3 · Gaussian GLM = Linear Model ──────────────────────────────
...
``` r
# ── Part 2.4 · Gaussian GLM = Linear Model ──────────────────────────────
...
``` r
# ── Part 2.5 · Gaussian GLM = Linear Model ──────────────────────────────
...
✏️ **Your turn:** Do the emmeans and pairwise p-values from `lm_model` and `gauss_model` match?
...
``` r
# ── Part 4.1 · Negative Binomial GLM ────────────────────────────────────
...
``` r
# ── Part 4.2 · Negative Binomial GLM ────────────────────────────────────
...
``` r
# ── Part 4.3 · Negative Binomial GLM ────────────────────────────────────
...
✏️ **Your turn:** Compare the overdispersion check result from the Poisson model (Part 3) to the negative binomial model here. Did switching to NB fix the overdispersion problem?
...
``` r
# ── Part 4.4 · Negative Binomial GLM ────────────────────────────────────
...
``` r
# ── Part 5.1 · Gaussian, Poisson & Negative-Binomial ────────────────────
...
``` r
# ── Part 5.2 · Gaussian, Poisson & Negative-Binomial ────────────────────
...
``` r
# ── Part 5.3 · Gaussian, Poisson & Negative-Binomial ────────────────────
...
``` r
# ── Part 5.4 · Gaussian, Poisson & Negative-Binomial ────────────────────
...
✏️ **Your turn:** Compare the three model fits (Gaussian, Poisson, Negative Binomial) for `spp ~ area`. Based on the DHARMa diagnostics and overdispersion checks, which model would you report?
...
✏️ **Your turn:** Based on the odds ratio, for every one-unit increase in island Perimeter/Area ratio, how are the odds of finding a lizard present changing?
