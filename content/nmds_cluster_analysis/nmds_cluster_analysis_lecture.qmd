---
title: "Lecture: NMDS & Cluster Analysis"
subtitle: "Community ordination"
description: "Non-metric Multidimensional Scaling (NMDS), PERMANOVA, and ANOSIM for community ecology data — Bray-Curtis dissimilarity, stress and Shepard diagrams, testing group differences, dispersion diagnostics, and environmental drivers, using the classic Doubs River fish community dataset."
...
## NMDS - Multivariate Community Analysis
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Two stacked plots of the Doubs River sampling design: altitude versus distance from source with points colored by river reach, and species richness versus distance from source with a loess smooth, both showing values changing as the river flows downstream."
...
## Part 2 · The NMDS Algorithm {.divider}
...
::: callout-note
Gotelli & Ellison, *A Primer of Ecological Statistics*, Ch. 12 — The Analysis of Multivariate Data, covers ordination methods including NMDS.
:::
::::
...
#| warning: false
#| paged-print: false
#| fig-alt: "Heatmap of the Bray-Curtis dissimilarity matrix for the first 15 river sites, with cells colored from white (identical) to dark red (completely different) and dissimilarity values printed in each cell."
#|
...
#| warning: false
#| paged-print: false
#| fig-alt: "Line plot of simulated NMDS stress declining over 50 iterations, with dashed reference lines at 0.1 (good threshold) and 0.2 (poor threshold)."
#|
...
## Part 3 · Stress and Model Diagnostics {.divider}
...
#| warning: false
#| paged-print: false
#| fig-alt: "Shepard diagram for the fish NMDS: a scatterplot of ordination distance versus original Bray-Curtis dissimilarity for every pair of sites, with a stepped monotonic regression line, showing points closely tracking the line."
...
#| warning: false
#| paged-print: false
#| fig-alt: "The same Shepard diagram for the fish NMDS repeated, shown alongside the discussion of stress guidelines for interpreting scatter around the monotonic line."
# Create Shepard diagram
stressplot(fish_nmds, main = "Shepard Diagram for Fish NMDS")
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Scree plot of NMDS stress versus number of dimensions (1 to 6), with dashed reference lines at the 0.10 good and 0.20 acceptable stress thresholds, used to find the elbow where added dimensions stop meaningfully reducing stress."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Scatterplot of a simulated sinusoidal (non-linear) relationship colored by group, with a red dashed linear fit line and a blue loess curve, showing the linear fit missing the true non-linear pattern that NMDS is robust to."
...
## Part 4 · Running and Visualizing NMDS {.divider}
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Shepard diagram (NMDS stress plot) for the fish community NMDS, showing ordination distance versus original dissimilarity closely tracking the monotonic fit line, consistent with the reported stress of 0.074."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Basic NMDS ordination plot with sites plotted as text labels in 2D NMDS space, the raw base-R output before adding color-by-reach styling."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Two side-by-side NMDS ordination plots of fish community sites: one colored by river reach with confidence ellipses showing clear separation between upstream, midstream, and downstream groups; the other colored by continuous distance from source showing a smooth gradient."
...
#| fig-height: 3.6
#| fig-width: 3.6
#| fig-alt: "NMDS ordination plot with convex hull polygons drawn around sites in each river reach, species names plotted as grey text labels, and site points colored by reach, showing fish community composition structured along the river."
...
#| warning: false
#| paged-print: false
#| fig-alt: "Scatterplot of three simulated groups with confidence ellipses and X marks showing each group's centroid, illustrating the concept PERMANOVA tests: whether group centroids differ."
...
#| warning: false
#| paged-print: false
#| fig-alt: "Histogram of the null distribution of F-statistics from 999 PERMANOVA permutations, with a red vertical line marking the observed F-statistic (8.5) far to the right of the null distribution."
...
#| warning: false
#| paged-print: false
#| fig-alt: "NMDS ordination plot of fish community sites colored by river reach with confidence ellipses, black X marks and text labels showing each reach's group centroid, illustrating the centroid differences PERMANOVA tests."
...
#| warning: false
#| paged-print: false
#| fig-alt: "PCoA-based dispersion plot showing sites in each river reach with lines connecting each site to its group centroid, and confidence ellipses, used to check the homogeneity-of-dispersion assumption for PERMANOVA."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Combined figure: an NMDS plot with centroids and confidence ellipses by river reach on top, and a table of pairwise PERMANOVA comparison results (F-statistic, R-squared, adjusted p-value) below."
...
#| fig-height: 3.6
#| fig-width: 3.6
#| fig-alt: "NMDS ordination plot with colored segments connecting each site to its river-reach centroid (within-group distances) and red lines connecting the reach centroids to each other (between-group distances), illustrating the logic ANOSIM tests."
...
-   Interpreting R:
    ...
    #| warning: false
    #| paged-print: false
    #| fig-alt: "Boxplots of dissimilarity ranks for within-group versus between-group comparisons from the ANOSIM test, showing the within-group box clearly lower than the between-group box, consistent with an R-statistic of 0.51."
...
## Part 7 · Comparing PERMANOVA and ANOSIM {.divider}
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Three side-by-side scatterplots of simulated two-group data with confidence ellipses and centroid markers, illustrating three scenarios: a clear centroid difference detected by both PERMANOVA and ANOSIM, a dispersion-only difference misleadingly flagged by PERMANOVA but not ANOSIM, and a combined location-and-dispersion difference detected by both."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Scatterplot of two simulated groups with the same centroid but very different spread, with confidence ellipses and centroid markers, showing why PERMANOVA can misleadingly flag a 'significant' result driven only by dispersion differences."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Scatterplot of two simulated groups with lines connecting each point to its group centroid and a double-headed arrow between the two centroids, illustrating that PERMANOVA tests whether the distance between group centroids is significant."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Scatterplot of two simulated groups with green solid lines connecting example within-group point pairs and orange dashed lines connecting example between-group point pairs, illustrating that ANOSIM compares whether within-group distances rank shorter than between-group distances."
...
#| fig-width: 3.6
#| paged-print: false
#| fig-alt: "Two side-by-side scatterplots of the same simulated two-group data: the left panel shows the PERMANOVA view with centroid distances, the right panel shows the ANOSIM view with within- versus between-group distance lines."
...
## Part 8 · Environmental Drivers and Wrap-Up {.divider}
...
#| warning: false
#| paged-print: false
#| fig-alt: "NMDS ordination plot of fish community sites colored by river reach, with red arrows overlaid showing the direction and strength of significant environmental variables (such as distance from source, oxygen, and biological oxygen demand)."
...
#| warning: false
#| paged-print: false
#| fig-alt: "Two-panel figure: faceted scatterplots of pH, oxygen, biological oxygen demand, and altitude against distance from source with loess trend lines colored by river reach; and a correlation heatmap of the two NMDS axes against each environmental variable, with correlation values printed in each cell."
