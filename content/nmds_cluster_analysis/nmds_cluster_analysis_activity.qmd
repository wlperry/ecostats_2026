...
>
> **Every grey `r` box below is code you type into an R script — not into the Console.** Before you start: **File → New File → R Script**, and save it as `10_nmds_permanova.R` in your project's `scripts/` folder. Then work down the worksheet, adding each block to the bottom of that one script, in order.
>
...
``` r
# ── Part 1.1 · Data Preparation and Exploration ─────────────────────────
...
``` r
# ── Part 1.2 · Data Preparation and Exploration ─────────────────────────
...
``` r
# ── Part 1.3 · Data Preparation and Exploration ─────────────────────────
...
✏️ **Your turn:** Fill in from your own output — Stress value: `______`. Is that excellent (<0.1), good (0.1–0.2), or poor (>0.2)?
...
``` r
# ── Part 2.6 · Running NMDS ─────────────────────────────────────────────
stressplot(iris_nmds_model, main = "Shepard Diagram: Ordination vs Original Distances")
```

✏️ **Your turn:** Do the three species separate cleanly on the NMDS plot, or do any overlap?
...
✏️ **Your turn:** Which pair of species is the most different (largest F-statistic)? Which pair is the least different?
...
``` r
# ── Part 3.5 · PERMANOVA Analysis ───────────────────────────────────────
# Write your notes/code in the R script:
```
:::
...
``` r
# ── Part 5.1 · Environmental Fitting (Optional) ─────────────────────────
...
``` r
# ── Part 5.2 · Environmental Fitting (Optional) ─────────────────────────
...
``` r
# ── Part 5.3 · Environmental Fitting (Optional) ─────────────────────────
