...
✏️ **Your turn:** Why do we average by `team` and `side` before doing anything else? How many rows did we start with, and how many are left? `________________________`
