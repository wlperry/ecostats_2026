...
# Worksheet 7: Power and Type I & II Error
...
Deciding between the standard t-test (equal variances) and Welch's t-test (unequal variances) depends on a Levene's test result — review Worksheet 6 if you need a refresher.
...
✏️ **Your turn:** Change the two hex-ish color names in `values =` to two colors of your own choosing (e.g., `"steelblue"`, `"darkorange"`). Re-run and confirm the plot updates.
