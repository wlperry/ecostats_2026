...
You already calculated `dz` in the Non-Parametric lecture — **−1.36**, the large effect we could not pin down. This is what that number is *for*.
...
And the signed-rank floor closes too: at 4 pairs the smallest possible p was 0.125; at **7 pairs** it is `2 / 2^7` = 0.016. One more field afternoon fixes both problems at once.
:::
::::
:::::::
