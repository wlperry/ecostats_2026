...
Six columns: `date`, `group` (field team name), `n_s`, `sun`, `tree_no`, `length_mm`. Same structure whether it came from the `.csv` or the `.xlsx`.
:::
::::
...
::: callout-note
**🔮 Predict first:** `n_s == "n" | length_mm > 22` keeps a row if the side is shady **or** the needle is longer than 22mm. Will this ever keep a *sunny* needle? Under what condition?
:::
