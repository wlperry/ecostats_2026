...
`summarize()` is Describing Your Data's whole topic. Today: the other four, plus saving what you build.
:::
::::
...
`pine_csv_df` has no missing values, so `is.na()` has nothing to catch here. Describing Your Data digs into *why* missing values matter so much once you're computing a sample size or a mean.
:::
::::
:::::::
