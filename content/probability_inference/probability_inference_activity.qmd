...
>
> **Every grey `r` box below is code you type into an R script — not into the Console.** Before you start: **File → New File → R Script**, and save it as `05_probability_inference.R` in your project's `scripts/` folder. Then work down the worksheet, adding each block to the bottom of that one script, in order.
>
...
> 📖 **Read more:** Whitlock & Schluter Ch. 3 (Describing Data) and Ch. 4 (Estimating with Uncertainty) on Canvas.
...
> 📖 **Read more:** Whitlock & Schluter Ch. 2 (Displaying Data) on frequency distributions; Gotelli & Ellison Ch. 2 (Random Variables and Probability Distributions).
...
``` r
# ── Part 3.1 · Frequency Distributions ──────────────────────────────────
i3_df %>%
...
``` r
# ── Part 3.2 · Frequency Distributions ──────────────────────────────────
...
``` r
# ── Part 3.3 · Frequency Distributions ──────────────────────────────────
g_df %>%
...
> 📖 **Read more:** Whitlock & Schluter Ch. 5 (Probability) — a density curve is a probability distribution drawn.
...
``` r
# ── Part 4.1 · From Histograms to Density Plots ─────────────────────────
i3_df %>%
  ggplot(aes(x = length_mm)) +
...
``` r
# ── Part 4.2 · From Histograms to Density Plots ─────────────────────────
i3_df %>%
  ggplot(aes(x = length_mm)) +
...
> 📖 **Read more:** Whitlock & Schluter Ch. 5 (Probability) and Ch. 10 (The Normal Distribution); Gotelli & Ellison Ch. 2.
...
``` r
# ── Part 5.1 · Area Under the Density Curve ─────────────────────────────
...
``` r
# ── Part 5.2 · Area Under the Density Curve ─────────────────────────────
...
> 📖 **Read more:** Whitlock & Schluter Ch. 10 (The Normal Distribution) — standardizing a value and reading the normal table.
...
> 📖 **Read more:** Whitlock & Schluter Ch. 11 (Inference for a Normal Population) for the one-sample t-test, and Ch. 6 (Hypothesis Testing) for the logic behind it.
...
``` r
# ── Part 7.1 · Comparing a Sample Mean to an Expected Mean ──────────────
i3_df <- g_df %>% filter(lake == "I3")
...
> 📖 **Read more:** Whitlock & Schluter Ch. 12 (Comparing Two Means) and Ch. 6 (Hypothesis Testing) on one- vs. two-tailed tests; Gotelli & Ellison Ch. 4 (Framing and Testing Hypotheses).
...
**Where each part of this worksheet lives:**

| Worksheet part | Read |
|----------------|------|
| Parts 2-3 — summary stats, histograms | W&S Ch. 2-4 |
| Parts 4-5 — density curves, area as probability | W&S Ch. 5; Gotelli Ch. 2 |
| Part 6 — z-scores | W&S Ch. 10 |
| Part 7 — one-sample t-test | W&S Ch. 11; W&S Ch. 6 |
| Part 8 — two-sample t-test | W&S Ch. 12; Gotelli Ch. 4 |

**If you want more:**

- Whitlock & Schluter, Ch. 13 — Handling Violations of Assumptions, for checking normality before you trust any of this
- **R for Data Science (2e)**, free online: [§10 — Exploratory data analysis](https://r4ds.hadley.nz/EDA.html) and [§9 — Layers](https://r4ds.hadley.nz/layers.html) for the density and histogram plots
