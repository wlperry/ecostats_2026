...
::: {.column width="40%"}
![Standard normal (Z) table giving the cumulative area to the left of z for z-values from 0.0 to 3.4 in rows and hundredths in columns, used to look up the proportion of a normal distribution below a given z-score.](images/clipboard-1995791111.png){width="380" height="367"}
:::
:::::
...
::: {.column width="40%"}
![Student's t critical-value table with one-tail and two-tail probabilities across the columns and degrees of freedom down the rows, used to look up the t-value for a chosen confidence level and sample size.](images/clipboard-3203878802.png){width="380" height="392"}
:::
:::::
...
::: {.column width="40%"}
![The same Student's t critical-value table repeated, with probabilities along the top and degrees of freedom down the left column, illustrating how to read off a critical t-value for a given df and confidence level.](images/clipboard-3203878802.png){width="380" height="410"}
:::
:::::
...
![Bell-shaped t-distribution curve with the area to the left of t = 1.328 shaded, illustrating a one-tailed cutoff.](images/clipboard-1822465473.png){width="180" height="150"}
:::

::: {.column width="40%"}
![Student's t critical-value table with the one-tail 0.10 column and df = 19 row highlighted, intersecting at the critical value 1.328, the value used for a one-tailed test with n = 20.](images/clipboard-641796945.png){width="380" height="405"}
:::
:::::
...
![Bell-shaped t-distribution curve with both tails shaded beyond t = -1.729 and t = 1.729, illustrating a two-tailed cutoff.](images/clipboard-2234740159.png){width="276" height="200"}
:::

::: {.column width="40%"}
![Student's t critical-value table with the two-tail 0.10 column and df = 19 row highlighted, intersecting at the critical value 1.729, the value used for a two-tailed test with n = 20.](images/clipboard-1734806681.png){width="380" height="464"}
:::
:::::
...
::: {.column width="40%"}
![Student's t critical-value table with the two-tail 0.05 column and df = 8 row highlighted, intersecting at the critical value 2.306, the value used to compute the 95% confidence interval in this worked example.](images/clipboard-3959630930.png)
:::
:::::
