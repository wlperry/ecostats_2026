...
>
> **Every grey `r` box below is code you type into an R script — not into the Console.** Before you start: **File → New File → R Script**, and save it as `08_nonparametric_t_tests.R` in your project's `scripts/` folder. Then work down the worksheet, adding each block to the bottom of that one script, in order.
>
...
# Part 6b · Our Pine Needles, the Non-Parametric Way
...
``` r
# ── Part 6b.1 · Our Pine Needles, the Non-Parametric Way ────────────────
...
``` r
# ── Part 6b.2 · Our Pine Needles, the Non-Parametric Way ────────────────
