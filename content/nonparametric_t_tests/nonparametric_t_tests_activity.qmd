...
✏️ **Your turn:** Did the two approaches lead you to the same *conclusion*? Did they give the same *p-value*? `________________________`

✏️ **Your turn:** Look at the signed-rank statistic, `V`. What value did you get, and what does it say about how consistent the four trees were? `________________________`
...
✏️ **Your turn:** Compare that number to the p-value you got from the signed-rank test. What does that tell you about whether the test *could* have found our effect significant, even in principle? `________________________`

✏️ **Your turn:** Based on all of this, which test would you report for the pine needle data, and why? `________________________`
