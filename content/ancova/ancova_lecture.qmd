...
# Combine plots
ancova_vis_combined <- (ancova_vis_plot1 + ancova_vis_plot2) / (ancova_vis_plot3 + ancova_vis_plot4) +
  plot_layout(guides = "collect") +
  plot_annotation(title = "Visualization Options for ANCOVA Results",
                 theme = theme(plot.title = element_text(size = 16, hjust = 0.5)))

ggsave("images/ancova_vis_combined.png", ancova_vis_combined, width = 7, height = 6, dpi = 300)
```
