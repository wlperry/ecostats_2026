...
>
> **Every grey `r` box below is code you type into an R script — not into the Console.** Before you start: **File → New File → R Script**, and save it as `08_ancova.R` in your project's `scripts/` folder. Then work down the worksheet, adding each block to the bottom of that one script, in order.
>
...
``` r
# ── Part 1.1 · Cricket Chirping Analysis ────────────────────────────────
set.seed(456)
n <- 40
...
``` r
# ── Part 1.2 · Cricket Chirping Analysis ────────────────────────────────
...
``` r
# ── Part 1.3 · Cricket Chirping Analysis ────────────────────────────────
...
``` r
# ── Part 1.4 · Cricket Chirping Analysis ────────────────────────────────
...
✏️ **Your turn:** Based on the `Anova()` output, is there a significant species effect on chirping rate after adjusting for temperature?
...
``` r
# ── Part 1.5 · Cricket Chirping Analysis ────────────────────────────────
par(mfrow = c(2, 2))
...
``` r
# ── Part 1.6 · Cricket Chirping Analysis ────────────────────────────────
...
``` r
# ── Part 1.7 · Cricket Chirping Analysis ────────────────────────────────
...
``` r
# ── Part 1.8 · Cricket Chirping Analysis ────────────────────────────────
...
``` r
# ── Part 1.9 · Cricket Chirping Analysis ────────────────────────────────
...
``` r
# ── Part 2.1 · Partridge Longevity Analysis ─────────────────────────────
...
``` r
# ── Part 2.2 · Partridge Longevity Analysis ─────────────────────────────
...
``` r
# ── Part 2.3 · Partridge Longevity Analysis ─────────────────────────────
...
``` r
# ── Part 2.4 · Partridge Longevity Analysis ─────────────────────────────
par(mfrow = c(2, 2))
plot(p_ancova_model)
par(mfrow = c(1, 1))
...
``` r
# ── Part 2.5 · Partridge Longevity Analysis ─────────────────────────────
...
``` r
# ── Part 2.6 · Partridge Longevity Analysis ─────────────────────────────
...
✏️ **Your turn:** According to the compact letter display, which treatment(s) had the highest adjusted mean longevity? Does that match what you'd predict biologically?
...
``` r
# ── Part 3.1 · Example with Heterogeneous Slopes ────────────────────────
set.seed(345)
...
``` r
# ── Part 3.2 · Example with Heterogeneous Slopes ────────────────────────
...
``` r
# ── Part 3.3 · Example with Heterogeneous Slopes ────────────────────────
...
``` r
# ── Part 3.4 · Example with Heterogeneous Slopes ────────────────────────
library(interactions)
...
✏️ **Your turn:** Based on the Johnson-Neyman output, over what range of `volume` (if any) do the treatment groups differ significantly?
...
``` r
# ── Part 3.5 · Example with Heterogeneous Slopes ────────────────────────
# Write your code in the R script:
```
:::
