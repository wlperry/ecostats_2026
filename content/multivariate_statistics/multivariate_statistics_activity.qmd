...
>
> **Every grey `r` box below is code you type into an R script — not into the Console.** Before you start: **File → New File → R Script**, and save it as `09_multivariate_statistics.R` in your project's `scripts/` folder. Then work down the worksheet, adding each block to the bottom of that one script, in order.
>
...
``` r
# ── Part 1.1 · Load and Explore the Data ────────────────────────────────
...
``` r
# ── Part 1.2 · Load and Explore the Data ────────────────────────────────
...
✏️ **Your turn:** Which variable(s) have the largest values (dominating the raw scale), and which have the smallest?
...
✏️ **Your turn:** Which pair of variables has the strongest correlation? Does that make biological sense?
...
``` r
# ── Part 4.2 · Running PCA ──────────────────────────────────────────────
fviz_eig(pca_result,
         addlabels = TRUE,
         ylim = c(0, 50))
```

✏️ **Your turn:** Based on the scree plot, how many components would you retain, and why?
...
``` r
# ── Part 5.1 · Interpreting Loadings ────────────────────────────────────
...
``` r
# ── Part 5.2 · Interpreting Loadings ────────────────────────────────────
pc1_loads <- tibble(
...
``` r
# ── Part 5.3 · Interpreting Loadings ────────────────────────────────────
pc2_loads <- tibble(
  Variable = rownames(pca_result$rotation),
...
``` r
# ── Part 5.4 · Interpreting Loadings ────────────────────────────────────
...
``` r
# ── Part 6.1 · Scores and Ordination ────────────────────────────────────
...
``` r
# ── Part 6.2 · Scores and Ordination ────────────────────────────────────
...
``` r
# ── Part 6.3 · Scores and Ordination ────────────────────────────────────
...
✏️ **Your turn:** Looking at the scores plot, do the sites appear to separate from each other, or do they overlap heavily?
...
``` r
# ── Part 7.1 · Distances Between Sites ──────────────────────────────────
...
✏️ **Your turn:** Which two sites are the most different from each other (largest centroid distance)? Which two are the most similar?
...
``` r
# ── Part 7.2 · Distances Between Sites ──────────────────────────────────
# Write your code in the R script:
```
:::
