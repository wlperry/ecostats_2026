...
`n_s` and `wind` always travel together — `n` with `lee`, `s` with `wind`. Two columns encoding the same grouping. Useful redundancy, or something to simplify? We'll revisit this in Wrangling Your Data.
:::
::::
