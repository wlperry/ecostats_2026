...
#| fig-width: 2
#| fig-height: 2
#| fig-alt: "Scatterplot of pine needle length in millimeters for the 'n' (north/sheltered) and 's' (south/exposed) groups, with individual points shown for each side."
