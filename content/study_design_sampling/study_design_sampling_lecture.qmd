...
:::: {.column width="40%"}
![Photo of a handwritten field notebook page recording site data (site ID, time, depth, GPS coordinates, substrate notes) for three sampling stations, an example of real field-study record-keeping.](images/clipboard-3712542164.png){width="300" height="200"}
::::
:::::::
...
![Close-up photo of a rock surface with a circular grazed patch (dark, cleared algae in the center) surrounded by a mosaic of ungrazed, algae-covered tiles, illustrating a herbivore grazing-scar pattern from a classic stream ecology study.](images/clipboard-1432414496.png){width="300"}
::::

:::: {.column width="40%"}
![Photo of an experimental array of small tiles laid on a streambed, some darker with algal growth and others lighter/grazed clean, used in Lamberti and Resh's (1983) study of caddisfly grazing effects on periphyton.](images/clipboard-1638932598.png){width="300" height="199"}
...
:::: {.column width="40%"}
![Humorous meme of a dog looking out a window with text joking that its barking is the reason the mail carrier always leaves unharmed ('I have the power of barking to thank for that'), a lighthearted example of mistaking correlation/coincidence for causation.](images/clipboard-733522902.png){width="300" height="248"}
::::
:::::::
...
:::: {.column width="40%"}
![Scatterplot of spider density against lizard density across survey plots, showing a clear negative relationship, an example of a natural experiment using existing variation rather than manipulation.](images/clipboard-194557558.png){width="300" height="266"}
::::
:::::::
...
:::: {.column width="40%"}
![Two causal diagrams: a 'confounder' diagram where Moisture has arrows pointing to both Lizard density and Spider density (a third variable driving both), and a 'mediator' diagram where Moisture points to Lizard density which in turn points to Spider density (an indirect causal chain).](images/clipboard-3939861261.png){width="300" height="406"}
::::
:::::::
...
:::: {.column width="40%"}
![Aerial photo of a large grid of manipulated experimental field plots surrounded by forest, part of the Cedar Creek Ecosystem Science Reserve's long-term biodiversity experiments.](images/clipboard-1608622199.png){width="300" height="276"}
...
:::: {.column width="40%"}
![Diagram of a confounding variable Z with arrows pointing to both X and Y, illustrating that a third variable can drive an apparent relationship between the two variables of interest.](images/clipboard-1454702014.png){width="300" height="200"}
::::
:::::::
...
:::: {.column width="40%"}
![The same tile-array photo repeated, shown here as an example of replicated experimental units on a streambed.](images/clipboard-1638932598.png){width="300" height="264"}
::::
:::::::
...
:::: {.column width="40%"}
![Map showing the burned area of the 'Camp House Fire' as an orange shape near Brimson, Minnesota, with roads and nearby towns labeled, illustrating a real forest-fire footprint for the burnt-versus-unburnt forest replication example.](images/clipboard-3427337242.png){width="300"}
::::
:::::::
...
:::: {.column width="40%"}
![Diagram of an aquarium tank containing a fish, a shelter labeled (a), prey items labeled (b), and a barrier or structure labeled (c), used to illustrate the barnacle/copper-aquaria pseudoreplication example where settling plates within the same tank are not true replicates.](images/clipboard-1877860945.png){width="300"}
::::
:::::::
...
:::: {.column width="40%"}
![Aerial photo of an outdoor research facility with about 20 large circular tanks (mesocosms) arranged in a grid on gravel, plus additional smaller tanks in the background, illustrating replicated temperature-controlled growth chambers.](images/clipboard-3600266009.png){width="300"}
::::
:::::::
...
:::: {.column width="40%"}
![Photo of a mother rat nursing a litter of newborn pups, illustrating the independence example: offspring from one mother are not independent replicates of each other.](images/clipboard-1994036977.png){width="300" height="395"}
::::
:::::::
...
:::: {.column width="40%"}
![Diagram of a shoreline (land at bottom, water at top) with shaded squares labeled E (experimental) and unshaded squares labeled C (control) interspersed randomly across the plots, illustrating random assignment of units to treatment and control.](images/clipboard-425378447.png){width="300" height="211"}
::::
:::::::
...
:::: {.column width="40%"}
![Diagram of a blue lake with black squares scattered haphazardly throughout the water, illustrating simple random sampling where every point has an equal chance of being sampled.](images/clipboard-1715765919.png){width="300" height="214"}
::::
:::::::
...
:::: {.column width="40%"}
![Diagram of a lake divided into three concentric depth strata (shallow green, mid-depth light blue, deep dark blue), with sample points scattered within each stratum, illustrating stratified random sampling.](images/clipboard-4229571822.png){width="300" height="240"}
::::
:::::::
...
:::: {.column width="40%"}
![Diagram of a lake with four red circles marking clusters, each containing three sample points, positioned around the shoreline, illustrating cluster sampling where whole groups near a location are sampled together.](images/clipboard-3497374488.png){width="300" height="250"}
::::
:::::::
...
:::: {.column width="40%"}
![Diagram of a lake with sample points evenly spaced in a grid-like pattern across the water, illustrating systematic sampling along a regular interval rather than at random locations.](images/clipboard-1509791440.png){width="300" height="225"}
::::
:::::::
