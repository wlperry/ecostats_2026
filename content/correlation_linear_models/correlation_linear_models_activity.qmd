...
✏️ **Your turn:** Do the Pearson and Spearman results agree on the direction and significance of the relationship?
...
✏️ **Your turn:** Does `ss_regression + ss_residual` match `ss_total`? Does `ss_regression` match the "prop_black" row's Sum Sq in `anova_table`?
