...
✏️ **Your turn:** Are the iris variables sufficiently correlated for PCA to be useful? Do you see any concerning outliers?
...
✏️ **Your turn:** Which variable has the largest loading on PC1? On PC2?
...
✏️ **Your turn:** In the biplot, which species has the largest (most positive) PC1 scores? Which arrow(s) point in roughly the same direction as that species' cluster?
