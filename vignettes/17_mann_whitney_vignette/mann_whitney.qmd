...
order: 17
week: 2
title: "Two Sample Mann-Whitney Test"
subtitle: "Mann-Whitney U test"
description: "Non-parametric two-sample Mann-Whitney U (Wilcoxon rank-sum) test in R."
resources: ["mann_whitney.R"]
author: "Bill Perry"
---

[📥 Download the R script](mann_whitney.R){.btn .btn-primary download="mann_whitney.R"}
