---
title: "Module 5 — Probability & Inference"
subtitle: "Z-scores, the t-distribution, confidence intervals, and hypothesis testing"
description: "Probability distributions and the logic of statistical inference: the standard normal distribution, Z-scores, standard error and confidence intervals, Student's t-distribution, and hypothesis testing (p-values, Type I/II errors, power) — all on the Arctic grayling length dataset."
categories: [Probability, Inference, R]
order: 5
week: 5
author: "Bill Perry"
...
::::::: columns
:::: {.column width="60%"}
Last time (Module 4) you:

-   Built boxplots with raw points overlaid
-   Mapped color/fill by group, plotted mean ± SE with `stat_summary()`
-   Faceted plots and saved a publication-ready figure with `ggsave()`

::: callout-note
**✅ Key idea from Module 4**

You can now describe and visualize a dataset end to end. Today we ask a harder question: how confident can we be that a pattern we see in a *sample* reflects something real about the *population*?
:::
::::
...
1.  Probability distributions & the standard normal
2.  Z-scores and the 68–95–99.7 rule
3.  Standard error, confidence intervals & the t-distribution
...
## Part 1 · Probability Distributions & the Standard Normal
...
::: callout-tip
📖 This module draws on Whitlock & Schluter's *The Analysis of Biological Data*, Ch. 4–6, and Gotelli & Ellison's *A Primer of Ecological Statistics*, Ch. 3–4. Full citations are on the final slide.
:::
::::
...
::: callout-note
📖 Whitlock & Schluter, Ch. 5 — *Probability*
:::
::::
...
## Part 2 · Z-scores and the 68–95–99.7 Rule
...
## Using the Standard Normal Distribution — Fish Data
...
::: callout-note
📖 Gotelli & Ellison, Ch. 3 — *Summary Statistics: Measures of Location and Spread*
:::
::::
...
## Z-score Example — Reading the Table
...
## Z-scores in R — pnorm(), qnorm(), dnorm()
...
## Applying pnorm()/qnorm() to the Fish Data
...
## Part 3 · Standard Error, Confidence Intervals & the t-Distribution
...
## Part 4 · Hypothesis Testing & P-values — One-Tailed Test
...
::: callout-note
📖 Whitlock & Schluter, Ch. 6 — *Hypothesis Testing*; Gotelli & Ellison, Ch. 4 — *Framing and Testing Hypotheses*
:::
::::
...
## Part 5 · Type I/II Errors and Power
...
::::::: columns
:::: {.column width="60%"}
-   Whitlock, M. C., & Schluter, D. (2020). *The Analysis of Biological
    Data* (3rd ed.). Macmillan Learning.
    -   Chapter 4 — Estimating with Uncertainty (SE, confidence
        intervals)
    -   Chapter 5 — Probability (distributions, Z-scores)
    -   Chapter 6 — Hypothesis Testing (p-values, Type I/II errors,
        power)
-   Gotelli, N. J., & Ellison, A. M. (2012). *A Primer of Ecological
    Statistics* (2nd ed.). Sinauer Associates.
    -   Chapter 3 — Summary Statistics: Measures of Location and
        Spread
...
Every distribution, test, and rule of thumb in this lecture (68–95–99.7,
Z-scores, SE, the t-distribution, p-values, Type I/II errors) is
covered in these two texts — use them as your reference when you're
stuck on a formula or an interpretation.
:::
::::
:::::::
...
2.  Check the usual suspects: `library(tidyverse)` loaded? Spelling?
    Did you forget `na.rm = TRUE`?
...
Every working scientist googles error messages daily. Getting stuck is
not failing — it is the job.
:::
